...
const Index = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    carModels: [
      "トヨタ｜アクア", "トヨタ｜プリウス", "トヨタ｜カローラ", "トヨタ｜ヤリス",
      "日産｜ノート", "日産｜セレナ", "日産｜デイズ",
      "ホンダ｜フィット", "ホンダ｜ヴェゼル", "ホンダ｜N-BOX",
      "スズキ｜スイフト", "スズキ｜ハスラー", "スズキ｜ワゴンR"
    ]
  });
  ...
  const [previousData, setPreviousData] = useState({
    ...
    carModels: [
      "メルセデス・ベンツ｜Cクラス", "メルセデス・ベンツ｜Eクラス", "メルセデス・ベンツ｜Sクラス",
      "BMW｜3シリーズ", "BMW｜5シリーズ", "BMW｜7シリーズ",
      "アウディ｜A3", "アウディ｜A4", "アウディ｜A6",
      "レクサス｜IS", "レクサス｜ES", "レクサス｜LS",
      "ポルシェ｜911", "ポルシェ｜カイエン", "ポルシェ｜パナメーラ",
      "フェラーリ｜F8トリブート", "フェラーリ｜SF90ストラダーレ",
      "ランボルギーニ｜ウラカン", "ランボルギーニ｜アヴェンタドール",
      "マセラティ｜ギブリ", "マセラティ｜クアトロポルテ",
      "ベントレー｜コンチネンタルGT", "ベントレー｜フライングスパー",
      "ロールスロイス｜ファントム", "ロールスロイス｜ゴースト"
    ]
  });
